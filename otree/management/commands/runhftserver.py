...
# for hft we like using the runserver
# since we use daphne's reactor to open
# tcp connection to the exchange
...
class Command(runserver.Command):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--num_workers', type=int,
            action='store', dest='num_workers', default=True,
            help='Number of workers to run under the main process.')
    ...
    def inner_run(self, *args, **options):
        ...
        # 4 workers have never been a problem
        # but as we increase number of players
        # and simultaneous events
        # we might experiment with this and see how
        # big the queue on redis gets
        ...
        channels_logger.level = logging.DEBUG
        try:
